...
class SaleComponentv2 extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.pages.sales.sale-componentv2', compact('locations', 'customers', 'customers2', 'products', 'locations'));
    }
    ...
    public function createProduct($id)
    {
        ...
        if (isset($this->selectedProducts[$id])) {
            $this->discount = $this->selectedProducts[$id]['discount'] * $this->selectedProducts[$id]['quantity'];
            $this->selectedProducts[$id]['quantity']++;
            $this->total = $this->selectedProducts[$id]['price'] * $this->selectedProducts[$id]['quantity'];
        } else {
    ...
    {
        if (isset($this->selectedProducts[$id]) && $this->selectedProducts[$id]['quantity'] > 0) {
            $this->selectedProducts[$id]['quantity']--;

            if ($this->selectedProducts[$id]['quantity'] == 0) {
    ...
    private function recalculateTotals() {
        ...
        foreach ($this->selectedProducts as $product) {
            ...
            $this->discount += $product['discount'] * $product['quantity'];
        }
    }
