            ...
            <div class="card custom-card">
                <div class="card-body add-products p-0">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="row gy-3">
                                            <div class="col-xl-4 col-md-6">
                                                <label for="product-name-add" class="form-label">Sales</label>
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                ...
                                                <input type="text" wire:model="product.sub_category_id" class="form-control  @error('product.sub_category_id') is-invalid @enderror" id="sub_category_id" placeholder="sub_category_id">
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                <label for="alert_quantity" class="form-label">alert_quantity </label>
                                                <input type="text" wire:model="product.alert_quantity" class="form-control  @error('product.alert_quantity') is-invalid @enderror" id="alert_quantity" placeholder="alert_quantity">
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                <label for="enable_stock" class="form-label">Enable stock</label>
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                <label for="enable_stock" class="form-label">is_active</label>
                    ...
                    <div class="px-4 py-3 border-top border-block-start-dashed d-sm-flex justify-content-start">
                        <button class="btn btn-success m-1" wire:click="updateData()"> sales</button>
